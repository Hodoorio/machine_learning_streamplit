#Orange3 
| 모델                        | AUC  | CA   | F1   | Precision | Recall | MCC  |
|-----------------------------|------|------|------|-----------|--------|------|
...
- **김기준** : 프로젝트 아이디어 제안 및 전체 진행 총괄 (팀장 역할 수행)
- **김현기** : AI 에이전트를 활용한 결과 검증 및 문제 해결 방안 제시
- **고명섭** : 프로젝트 관리 및 팀 운영 지원 (전 팀장 경험을 바탕으로 관리·감독)
- **강동민** : 알고리즘 및 모델 구현 담당 (코드 작성 및 실험 수행)
